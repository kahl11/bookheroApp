      ...
      <SafeAreaView style={[styles.container]}>
        ...
        >
          <View style={[styles.container_header_row, {}]}>
            ...
            <Text style={[styles.title_header, { marginLeft: 5 }]}>
              {chatId}
            </Text>
          </View>
          <View style={[{ flexDirection: "column", height: "100%" }]}>
            <ScrollView style={[{ flexGrow: 1, backgroundColor:colors.dark }]}
            onContentSizeChange={() => {
            ...
            <View style={[{ height: "20%", flexDirection: "row", backgroundColor: colors.background_grey }]}>
              <TextInput
                style={[
                  styles.input,
                  { width: "75%", marginTop: 10, height: 50 },
                ]}
              ...
              <TouchableOpacity
                style={[
                  touchable_styles.halfButtonDark,
                  { width: "20%", marginTop: 10, height: 50, paddingTop: 18 },
                ]}
                onPress={() => {
